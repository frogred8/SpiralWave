...
export const TRANSLATIONS: Record<Language, Record<string, string>> = {
    en: {
        ...
        'ui.game_tips_body': 'Collect wood and rock before time runs out. Pick a starting skill, pull resources into the spiral, and research upgrades to raise your score.',
    ...
    ko: {
        ...
        'ui.game_tips_body': '제한 시간 안에 나무와 돌을 최대한 모으세요. 시작 스킬을 고르고, 자원을 소용돌이로 끌어오며, 연구 업그레이드로 점수를 높이세요.',
    ...
    zh: {
        ...
        'ui.game_tips_body': '在时间结束前尽量收集木头和石头。选择初始技能，将资源拉入漩涡，并研究升级来提高分数。',
    ...
    ja: {
        ...
        'ui.game_tips_body': '制限時間内に木材と石材をできるだけ集めましょう。開始スキルを選び、資源を渦へ引き寄せ、研究アップグレードでスコアを伸ばします。',
