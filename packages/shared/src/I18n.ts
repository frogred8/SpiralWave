...
export const TRANSLATIONS: Record<Language, Record<string, string>> = {
    en: {
        ...
        'ui.manual_short': 'HELP',
        'ui.manual_title': 'Manual',
        'ui.manual_body': 'Controls\n- Arrow Keys: move the black hole after unlocking Move Speed.\n- Click or Tap: fire an idle robotic arm toward nearby resources.\n- H or HELP: open or close this manual.\n\nObjective\n- Collect as many wood and rock resources as possible before the timer ends.\n- Research upgrades during the run to expand collection radius, arm power, nets, satellites, and mobility.\n\nLoss Condition\n- The run ends when the selected time and any booster time are exhausted.',
        'tutorial.title': 'Tutorial',
        'tutorial.movement': 'Unlock Move Speed, then use the Arrow Keys to reposition the black hole.',
        'tutorial.arm': 'Click or tap near resources to send a robotic arm. A grab creates a short black-hole pull at the contact point.',
        'tutorial.research': 'Spend collected resources on research to keep improving this run.',
        ...
        'skill.q3.desc': 'Move Speed +1.0 (using Arrow Keys)',
    ...
    ko: {
        ...
        'ui.manual_short': '도움',
        'ui.manual_title': '매뉴얼',
        'ui.manual_body': '조작\n- 방향키: 이동 속도 해금 후 블랙홀을 움직입니다.\n- 클릭 또는 터치: 주변 자원을 향해 대기 중인 로봇팔을 발사합니다.\n- H 또는 도움: 이 매뉴얼을 열고 닫습니다.\n\n목표\n- 제한 시간이 끝나기 전까지 나무와 돌을 최대한 많이 수집합니다.\n- 진행 중 연구로 수집 범위, 로봇팔, 그물, 위성, 이동 능력을 강화합니다.\n\n패배 조건\n- 선택한 시간과 보너스 시간이 모두 소진되면 게임이 종료됩니다.',
        'tutorial.title': '튜토리얼',
        'tutorial.movement': '이동 속도를 해금한 뒤 방향키로 블랙홀 위치를 조정하세요.',
        'tutorial.arm': '자원 근처를 클릭하거나 터치하면 로봇팔이 발사됩니다. 잡는 순간 접촉 지점에 짧은 블랙홀 인력이 생깁니다.',
        'tutorial.research': '수집한 자원으로 연구를 진행해 이번 플레이를 계속 강화하세요.',
        ...
        'skill.q3.name': '이동 속도',
        'skill.q3.desc': '이동 속도 +1.0 (방향키 사용)',
        'skill.r1.name': '대형 자원',
    ...
    zh: {
        ...
        'ui.manual_short': '帮助',
        'ui.manual_title': '手册',
        'ui.manual_body': '操作\n- 方向键：解锁移动速度后移动黑洞。\n- 点击或轻触：让空闲机械臂抓取附近资源。\n- H 或帮助：打开或关闭本手册。\n\n目标\n- 在计时结束前尽可能收集木头和石头。\n- 在每局中研究升级，强化收集范围、机械臂、网、卫星和移动能力。\n\n失败条件\n- 选择时间和奖励时间全部耗尽后，本局结束。',
        'tutorial.title': '教程',
        'tutorial.movement': '解锁移动速度后，用方向键调整黑洞位置。',
        'tutorial.arm': '点击或轻触资源附近来发射机械臂。抓取时会在接触点生成短暂的黑洞吸引力。',
        'tutorial.research': '使用收集到的资源进行研究，继续强化本局能力。',
    ...
    ja: {
        ...
        'ui.manual_short': 'HELP',
        'ui.manual_title': 'マニュアル',
        'ui.manual_body': '操作\n- 方向キー: 移動速度を解放したあと、ブラックホールを移動します。\n- クリックまたはタップ: 近くの資源へ待機中のアームを発射します。\n- H または HELP: このマニュアルを開閉します。\n\n目標\n- タイマー終了までに木材と石材をできるだけ多く集めます。\n- プレイ中に研究を進め、収集範囲、アーム、ネット、衛星、移動能力を強化します。\n\n敗北条件\n- 選択時間とボーナス時間をすべて使い切るとゲーム終了です。',
        'tutorial.title': 'チュートリアル',
        'tutorial.movement': '移動速度を解放したら、方向キーでブラックホールの位置を調整しましょう。',
        'tutorial.arm': '資源の近くをクリックまたはタップするとアームを発射します。つかんだ地点に短時間のブラックホール引力が発生します。',
        'tutorial.research': '集めた資源で研究を進め、このプレイを強化し続けましょう。',
