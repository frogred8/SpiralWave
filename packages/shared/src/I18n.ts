...
export const TRANSLATIONS: Record<Language, Record<string, string>> = {
    ...
    ja: {
        ...
        'ui.choose_mid_game_skill': 'スキルを選択してください',
        'ui.choose_play_time': 'プレイ時間を選択',
        'ui.play_time_minutes': '{minutes}分',
        'ui.play_time_endless': 'エンドレス',
        'ui.game_over': 'タイムアップ！',
