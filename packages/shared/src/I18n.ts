...
export const TRANSLATIONS: Record<Language, Record<string, string>> = {
    en: {
        ...
        'ui.choose_play_time': 'Choose Play Time',
        ...
        'skill.arm_black_hole.desc': 'Creates a temporary black hole at the robotic arm contact point. Range +30 per level',
    ...
    ko: {
        ...
        'skill.arm_black_hole.desc': '로봇팔 접촉 지점에 임시 블랙홀 생성. 레벨당 범위 +30',
    ...
    zh: {
        ...
        'skill.arm_black_hole.desc': '在机械臂接触点生成临时黑洞。每级范围 +30',
        'skill.r4.name': '机械臂增设',
    ...
    ja: {
        ...
        'skill.arm_black_hole.desc': 'アームの接触地点に一時ブラックホールを生成。レベルごとに範囲 +30',
        'skill.r4.name': 'アーム増設',
