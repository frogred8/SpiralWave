...
export const TRANSLATIONS: Record<Language, Record<string, string>> = {
    en: {
        ...
        'ui.infinite_mode': 'Infinite',
        'ui.end_run': 'End Run',
        'ui.infinite_score': 'Infinite Score',
        'ui.leaderboard_bracket': '{minutes} min Rankings',
        'ui.leaderboard_bracket_infinite': 'Infinite Rankings',
        'ui.research_slots': 'Research Slots',
        'ui.next_slot': 'Next slot',
        'ui.max_slots': 'Max slots',
        'ui.special_items': 'Special Items',
        'ui.special_whitehole_effect': 'Spawns an enhanced white hole that bursts resources for 5s.',
        'ui.special_boost_effect': 'Expands collection radius by 60% for 5s, then shrinks smoothly.',
        'ui.skill_tree_deterministic': 'Fixed skill layout: plan upgrades by visible prerequisites.',
    ...
    ko: {
        ...
        'ui.infinite_mode': '무한',
        'ui.end_run': '종료',
        'ui.infinite_score': '무한 점수',
        'ui.leaderboard_bracket': '{minutes}분 랭킹',
        'ui.leaderboard_bracket_infinite': '무한 랭킹',
        'ui.research_slots': '연구 슬롯',
        'ui.next_slot': '다음 슬롯',
        'ui.max_slots': '최대 슬롯',
        'ui.special_items': '특수 아이템',
        'ui.special_whitehole_effect': '강화 화이트홀을 생성해 5초 동안 자원을 폭발적으로 뿌립니다.',
        'ui.special_boost_effect': '5초 동안 수집 반경을 60% 확장한 뒤 부드럽게 줄어듭니다.',
        'ui.skill_tree_deterministic': '고정 스킬 배치: 보이는 선행 조건으로 업그레이드를 계획하세요.',
        'ui.game_over': '시간 종료!',
    ...
    zh: {
        ...
        'ui.infinite_mode': '无限',
        'ui.end_run': '结束',
        'ui.infinite_score': '无限分数',
        'ui.leaderboard_bracket': '{minutes}分钟排名',
        'ui.leaderboard_bracket_infinite': '无限排名',
        'ui.research_slots': '研究槽',
        'ui.next_slot': '下个槽位',
        'ui.max_slots': '最大槽位',
        'ui.special_items': '特殊物品',
        'ui.special_whitehole_effect': '生成强化白洞，在5秒内爆发资源。',
        'ui.special_boost_effect': '收集半径扩大60%，持续5秒后平滑缩小。',
        'ui.skill_tree_deterministic': '固定技能布局：根据可见前置条件规划升级。',
        'ui.game_over': '时间到!',
    ...
    ja: {
        ...
        'ui.infinite_mode': '無限',
        'ui.end_run': '終了',
        'ui.infinite_score': '無限スコア',
        'ui.leaderboard_bracket': '{minutes}分ランキング',
        'ui.leaderboard_bracket_infinite': '無限ランキング',
        'ui.research_slots': '研究スロット',
        'ui.next_slot': '次のスロット',
        'ui.max_slots': '最大スロット',
        'ui.special_items': '特殊アイテム',
        'ui.special_whitehole_effect': '強化ホワイトホールを生成し、5秒間資源を噴出します。',
        'ui.special_boost_effect': '収集半径を5秒間60%拡大し、その後なめらかに縮小します。',
        'ui.skill_tree_deterministic': '固定スキル配置: 見える前提条件でアップグレードを計画できます。',
        'ui.game_over': 'タイムアップ！',
