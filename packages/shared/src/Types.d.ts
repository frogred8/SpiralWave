 ...
 * 스탯 속성 리스트
 */
export type EffectProperty = 'radius' | 'force' | 'highDimProb' | 'maxArms' | 'autoArm' | 'armSpeed' | 'maxResearchSlots' | 'spawnRate' | 'researchBonus' | 'moveSpeed' | 'net' | 'netAngle' | 'smallBlackHole' | 'smallBlackHoleRange' | 'netLength' | 'specialItemBooster';
